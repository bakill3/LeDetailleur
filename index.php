                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-11 col-md-11">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".2s">Lave-Auto</h1>
                                <div class="hero-details">
                                    <div class="stock-text" data-animation="fadeInUp" data-delay=".8s">
                                        <h2>& Détails</h2>
                                        <h2>& Détails</h2>
                                    </div>
                                    <P data-animation="fadeInUp" data-delay=".4s">Nous faisons de vous le meilleur lavage de voiture et les meilleurs détails.</P>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="services.html" class="btn mb-10"  data-animation="fadeInUp" data-delay=".8s">Nos services</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<section class="office-environments" >
    <div class="container">
        <div class="environments-wrapper section-bg02" data-background="assets/img/gallery/section_bg02_compressed.png">
            <div class="row">
                <div class="col-xl-7 col-lg-8 offset-xl-5 offset-lg-4">
                    <div class="office-pera">
                        <div class="section-tittle">
                            <h2 class="mb-30">Nous avons les derniers équipements</h2>
                            <p>Nous offrons des services de lavage de voitures complets et de qualité supérieure avec les meilleurs produits et équipements.</p>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-7 col-md-10">
                <div class="section-tittle text-center mb-90">
                    <h2>Nous offrons les meilleurs services à nos clients</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<section class="testimonial-area testimonial-padding fix">
    ...
    <div class="testimonial-right-img">
        <img src="assets/img/gallery/testimonial-right-img_compressed.png" alt="">
    </div>
</section>
...
<!--? Services Area End -->
<!--? video_start -->
<div class="video-area section-bg2 d-flex align-items-center"  data-background="assets/img/gallery/video-bg_compressed.png">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-lg-5 col-md-5 col-sm-5">
                <img src="assets/img/gallery/map-left_compressed.png" alt="" class="w-100">
            </div>
        </div>
    </div>
</div>
